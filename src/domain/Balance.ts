...
export const REGEN_KI_PER_TICK  = 10 as const; // +KI par action
export const REGEN_VIT_PER_TICK = 10 as const; // +VIT par action

export const LEECH_KI_PER_TICK  = 15 as const; // -KI sur la cible par action
//#endregion
...
export const DEFAULT_STATS_BY_RACE: Record<WarriorType, WarriorStats> = {
  Saiyan:   { strength: 100, ki: 100,  speed: 100, vitality: 100 },
  Namekian: { strength: 100, ki: 100,  speed: 100, vitality: 100 },
  Android:  { strength: 100, ki: 9999, speed: 100, vitality: 100 },
};
//#endregion
