// Rôle: Configuration : constantes de balance

import type { WarriorType, WarriorStats } from "./Warrior";

//#region Rounds / règles
export const SPECIAL_UNLOCK_TURN = 3 as const;      // Spéciale dispo à partir de ce round
...
// Libellés UI pour l'attaque Ki/Energy (affichage uniquement)
...
// Libellés UI de la Spéciale par race
...
export const SPECIAL_LOW_HEALTH_RATIO = 0.25 as const; // PV ≤ 25% autorise aussi
//#endregion
...
export const SSJ_STR_MULTIPLIER = 1.3 as const; // STR +30%
export const SSJ_SPD_MULTIPLIER = 1.2 as const; // SPD +20%
